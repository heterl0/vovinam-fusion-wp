				...
				<div class="row">
					<?php
						...
						if( !get_theme_mod( 'disable_sidebar_blog_page', false ) ){
							kortez_blog_left_sidebar( $sidebarColumnClass );
						} ?>
						...
						<?php
							if( !get_theme_mod( 'disable_pagination', false ) ):
								the_posts_pagination( array(
									'next_text' => '<span>'.esc_html__( 'Next', 'kortez-blog' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Next page', 'kortez-blog' ) . '</span>',
									'prev_text' => '<span>'.esc_html__( 'Prev', 'kortez-blog' ) .'</span><span class="screen-reader-text">' . esc_html__( 'Previous page', 'kortez-blog' ) . '</span>',
									'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'kortez-blog' ) . ' </span>',
								));
							endif;
						?>
					</div><!-- #primary -->
					<?php
						if( !get_theme_mod( 'disable_sidebar_blog_page', false ) ){
							kortez_blog_right_sidebar( $sidebarColumnClass );
						}
					?>
				</div>
		</section>
