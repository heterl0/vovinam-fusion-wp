...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="listarticle">
        ...
        <div class="entry-summary">
            <?php if(get_theme_mod('real_fitness_blog_post_description_option') == 'Full Content'){ ?>
                <div class="entry-content"><?php
                    $content = get_the_content(); ?>
                    <p><?php echo wpautop($content); ?></p>  
                </div>
             <?php }
            if(get_theme_mod('real_fitness_blog_post_description_option', 'Excerpt Content') == 'Excerpt Content'){ ?>
        ...
        <?php else : ?>
        <div class="entry-content">
            <?php the_content( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'real-fitness' ) ); ?>
            <?php
                wp_link_pages( array(
                    'before' => '<div class="page-links">' . __( 'Pages:', 'real-fitness' ),
                    'after'  => '</div>',
                ) );
            ?>
        </div>
