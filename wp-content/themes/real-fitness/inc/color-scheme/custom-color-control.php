...
if($real_fitness_color_scheme_one != false){
  ...
  $real_fitness_color_scheme_css .='color: '.esc_attr($real_fitness_color_scheme_one).';';

  $real_fitness_color_scheme_css .='}';

  $real_fitness_color_scheme_css .='.header{';

  $real_fitness_color_scheme_css .='background: rgba(0, 0, 0, 0) linear-gradient(130deg, #fff 35%, '.esc_attr($real_fitness_color_scheme_one).' 35% )repeat scroll 0 0 ;';
...
//---------------------------------Logo-Max-height--------- 
  $real_fitness_logo_width = get_theme_mod('real_fitness_logo_width');

  if($real_fitness_logo_width != false){

    $real_fitness_color_scheme_css .='.logo .custom-logo-link img{';

      $real_fitness_color_scheme_css .='width: '.esc_html($real_fitness_logo_width).'px;';
