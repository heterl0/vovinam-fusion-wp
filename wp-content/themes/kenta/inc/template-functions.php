...
function kenta_add_post_navigation() {
	...
	the_post_navigation( [
		'prev_text'          => $prev_thumbnail . '<div class="item-wrap px-gutter"><span class="item-label">' . esc_html__( 'Previous Post', 'kenta' ) . '</span><span class="item-title">%title</span></div>',
		'next_text'          => $next_thumbnail . '<div class="item-wrap px-gutter"><span class="item-label">' . esc_html__( 'Next Post', 'kenta' ) . '</span><span class="item-title">%title</span></div>',
