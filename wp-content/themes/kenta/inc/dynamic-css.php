 ...
 * @return mixed
 */
function kenta_global_css_vars( $selector, $suffix = '', $defaultScheme = false ) {
	...
	if ( $defaultScheme ) {
		$vars = [
			...
			'--kenta-primary-color'  => 'var(--kenta-light-primary-color)',
			'--kenta-primary-active' => 'var(--kenta-light-primary-active)',
			'--kenta-accent-color'   => 'var(--kenta-light-accent-color)',
			'--kenta-accent-active'  => 'var(--kenta-light-accent-active)',
			'--kenta-base-color'     => 'var(--kenta-light-base-color)',
			'--kenta-base-100'       => 'var(--kenta-light-base-100)',
			'--kenta-base-200'       => 'var(--kenta-light-base-200)',
			'--kenta-base-300'       => 'var(--kenta-light-base-300)',
		];
	}
	...
	$global_colors = apply_filters( 'kenta_global_color_vars', [
		'kenta_primary_color' => [
			'default' => 'kenta-light-primary-color',
			'active'  => 'kenta-light-primary-active',
		],
		'kenta_accent_color'  => [
			'default' => 'kenta-light-accent-color',
			'active'  => 'kenta-light-accent-active',
		],
		'kenta_base_color'    => [
			'default' => 'kenta-light-base-color',
			'100'     => 'kenta-light-base-100',
			'200'     => 'kenta-light-base-200',
			'300'     => 'kenta-light-base-300',
		],

		'kenta_dark_primary_color' => [
			'default' => 'kenta-dark-primary-color',
			'active'  => 'kenta-dark-primary-active',
		],
		'kenta_dark_accent_color'  => [
			'default' => 'kenta-dark-accent-color',
			'active'  => 'kenta-dark-accent-active',
		],
		'kenta_dark_base_color'    => [
	...
	foreach ( $global_colors as $setting => $args ) {
		...
		foreach ( $args as $key => $var ) {
			$preset_var_name = rtrim( substr( $color[ $key ], strlen( 'var(--' ) ), ')' );
			if ( Utils::str_starts_with( $color[ $key ], 'var' ) && isset( $palette[ $preset_var_name ] ) ) {
				$vars[ '--' . $var . $suffix ] = $palette[ $preset_var_name ];
				continue;
			}
